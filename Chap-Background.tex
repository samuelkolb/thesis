...
\begin{example}
Consider the clauses \cen{$c_1 = \{friends(x, y), friends(y, z)\}$\\$c_2 = \{friends(x, y), friends(a, b)\}$.} In clause~$c_1$ the two atoms in the body of the clause are linked by variable $y$. Therefore, clause~$c_1$ is connected. The two atoms occuring in the body of $c_2$, however, do not share a common variable and thus $c_2$ is not connected.
\end{example}
...
Formulas in this form consist of a conjunctions of clauses, which, in turn, consist of a disjunction of variables.
