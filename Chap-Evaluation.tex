...
\begin{experiment}
	...
	\begin{figure}
		...
		\centering
			\includegraphics[width=1\textwidth]{nosplit_noise_noise}
	...
	\begin{figure}
		...
		\centering
			\includegraphics[width=1\textwidth]{nosplit_noise_rankings}
...
% 	\begin{table}[!htp]
% 		\begin{tabularx}{\textwidth}{XXX}
% 			\textbf{Hard constraints}	& \textbf{Mean}	& \textbf{StdDev} \\
% 			\toprule
% 			Yes & 		0.770 & 0.082 \\
% 			No & 0.734 & 0.068
% 		\end{tabularx}
% 		\label{tbl:exp_speed_symm}
% 		\caption{Use of hard constraints for pruning}
% 	\end{table}
% \end{experiment}
